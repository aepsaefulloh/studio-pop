...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>Studio Pop - Administrator</title>
    ...
    <link href="<?php echo CMS_URL?>/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet"
        type="text/css" />
    <!--end::Page Vendors Styles-->
    <!--begin::Global Theme Styles(used by all pages)-->
    <link href="<?php echo CMS_URL?>/assets/plugins/global/plugins.bundle.css?<?php echo rand()?>" rel="stylesheet"
        type="text/css" />
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        <a href="index.html">
            <img alt="Logo" src="<?php echo CMS_URL?>/assets/media/logos/logo-light.png?<?php echo rand()?>" />
        </a>
        <div class="d-flex align-items-center">
            ...
            <button class="btn btn-hover-text-primary p-0 ml-2" id="kt_header_mobile_topbar_toggle">
                <span class="svg-icon svg-icon-xl">
                    <!--begin::Svg Icon | path:<?php echo CMS_URL?>/assets/media/svg/icons/General/User.svg?<?php echo rand()?>-->
            ...
            <div class="offcanvas-wrapper mb-5 scroll-pull">
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="<?php echo CMS_URL?>/assets/media/stock-600x400/img-1.jpg?<?php echo rand()?>"
                            title="" alt="" />
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="<?php echo CMS_URL?>/assets/media/stock-600x400/img-2.jpg?<?php echo rand()?>"
                            title="" alt="" />
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="<?php echo CMS_URL?>/assets/media/stock-600x400/img-3.jpg?<?php echo rand()?>"
                            title="" alt="" />
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="<?php echo CMS_URL?>/assets/media/stock-600x400/img-4.jpg?<?php echo rand()?>"
                            title="" alt="" />
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="<?php echo CMS_URL?>/assets/media/stock-600x400/img-8.jpg?<?php echo rand()?>"
                            title="" alt="" />
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                    ...
                    <div class="mb-15">
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="<?php echo CMS_URL?>/assets/media/svg/misc/006-plurk.svg?<?php echo rand()?>"
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="<?php echo CMS_URL?>/assets/media/svg/misc/015-telegram.svg?<?php echo rand()?>"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="<?php echo CMS_URL?>/assets/media/svg/misc/003-puzzle.svg?<?php echo rand()?>"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="<?php echo CMS_URL?>/assets/media/svg/misc/005-bebo.svg?<?php echo rand()?>"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="<?php echo CMS_URL?>/assets/media/svg/misc/014-kickstarter.svg?<?php echo rand()?>"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-5">
                            <span class="svg-icon svg-icon-warning mr-5">
                                <span class="svg-icon svg-icon-lg">
                                    <!--begin::Svg Icon | path:<?php echo CMS_URL?>/assets/media/svg/icons/Home/Library.svg?<?php echo rand()?>-->
                        ...
                        <div class="d-flex align-items-center bg-light-success rounded p-5 mb-5">
                            <span class="svg-icon svg-icon-success mr-5">
                                <span class="svg-icon svg-icon-lg">
                                    <!--begin::Svg Icon | path:<?php echo CMS_URL?>/assets/media/svg/icons/Communication/Write.svg?<?php echo rand()?>-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                        ...
                        <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-5">
                            <span class="svg-icon svg-icon-danger mr-5">
                                <span class="svg-icon svg-icon-lg">
                                    <!--begin::Svg Icon | path:<?php echo CMS_URL?>/assets/media/svg/icons/Communication/Group-chat.svg?<?php echo rand()?>-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                        ...
                        <div class="d-flex align-items-center bg-light-info rounded p-5">
                            <span class="svg-icon svg-icon-info mr-5">
                                <span class="svg-icon svg-icon-lg">
                                    <!--begin::Svg Icon | path:<?php echo CMS_URL?>/assets/media/svg/icons/General/Attachment2.svg?<?php echo rand()?>-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                        ...
                        <div class="text-left flex-grow-1">
                            ...
                            <div class="dropdown dropdown-inline">
                                <button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-md"
                                    ...
                                    <span class="svg-icon svg-icon-lg">
                                        <!--begin::Svg Icon | path:<?php echo CMS_URL?>/assets/media/svg/icons/Communication/Add-user.svg?<?php echo rand()?>-->
                                ...
                                <div class="d-flex flex-column mb-5 align-items-start">
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-circle symbol-40 mr-3">
                                            <img alt="Pic"
                                                src="<?php echo CMS_URL?>/assets/media/users/300_12.jpg?<?php echo rand()?>" />
                                        </div>
                                        <div>
                                            <a href="#"
                                ...
                                <div class="d-flex flex-column mb-5 align-items-end">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-circle symbol-40 ml-3">
                                            <img alt="Pic"
                                                src="<?php echo CMS_URL?>/assets/media/users/300_21.jpg?<?php echo rand()?>" />
                                        </div>
                                    </div>
                                    <div
    ...
    <div id="kt_scrolltop" class="scrolltop">
        <span class="svg-icon">
            <!--begin::Svg Icon | path:<?php echo CMS_URL?>/assets/media/svg/icons/Navigation/Up-2.svg?<?php echo rand()?>-->
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <polygon points="0 0 24 0 24 24 0 24" />
            ...
            <div class="offcanvas-wrapper mb-5 scroll-pull">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo1.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo2.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../demo2/dist"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo3.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../demo3/dist"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo4.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../demo4/dist"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo5.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../demo5/dist"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo6.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../demo6/dist"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo7.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../demo7/dist"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo8.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../demo8/dist"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo9.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../demo9/dist"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo10.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../demo10/dist"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo11.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../demo11/dist"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo12.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../demo12/dist"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo13.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../demo13/dist"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo14.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo15.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo16.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo17.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo18.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo19.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo20.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo21.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo22.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo23.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo24.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo25.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo26.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo27.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo28.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo29.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="<?php echo CMS_URL?>/assets/media/demos/demo30.png?<?php echo rand()?>" alt=""
                            class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#"
