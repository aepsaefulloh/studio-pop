...
if($submitcontent=='1'){	
	...
	foreach($_REQUEST as $k=>$v){
		...
		if (in_array(strtoupper($k), $entity['stock'])){
			$v=str_replace("'","`",$v);
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header border-0 py-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder text-dark">Stock</span>
                </h3>
                    ...
                    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
						...
						?>
                            <tr>
                                <td>
                                    <span
                                        class="text-dark-75 font-weight-bolder d-block font-size-lg"><?php echo $list['STOCK_DATE']?></span>
                                </td>
                                <td>
                                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">
									<?php 
									$vpr['CODE']=$list['CODE'];
									$listPr=getRecord('tbl_product',$vpr);
									echo $list['CODE'].' - '.$listPr['RESULT'][0]['PRODUCT'] 
									?>
									</span>
                                </td>
                                <td>
                                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg"><?php echo $confSize[$list['SIZE']]?></span>
                                </td>
                                <td>
                                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg"><?php echo $list['TOTAL']?></span>
                                </td>
                                <td class="pr-0">
