        ...
        <div class="card">
            ...
            <form class="stdform stdform2" method="post"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>URL</label>
                        <input type="text" class="form-control" placeholder="" name="URL" id="location2"
                        ...
                        <span class="field">
                            <select name="POS" class="form-control">
                                ...
                                <option value="SLIDER" <?php if($objDetail['POS']=='SLIDER') echo 'selected'?>>
                                    SLIDER (12850x500)</option>
                                <option value="SLIDER-MOBILE"
                                    <?php if($objDetail['POS']=='SLIDER-MOBILE') echo 'selected'?>>SLIDER-MOBILE
                                    (300x200)</option>
