                    ...
                    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
						...
						?>
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="text-dark-75 font-weight-bolder d-block font-size-lg"><?php echo $list['TITLE']?></span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span
                                        class="text-dark-75 font-weight-bolder d-block font-size-lg"> <?php echo $list['POS']?></span>
                                </td>
                                <td>
                                    <span
                                        class="text-dark-75 font-weight-bolder d-block font-size-lg"> <?php echo $list['ORDERNUM']?></span>
                                </td>
                                <td>
