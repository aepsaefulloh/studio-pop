            ...
            <div class="widgetbox box-inverse">
                ...
                <div class="widgetcontent nopadding">
                    <form class="stdform stdform2" method="post"
                        ...
                        <p>
                            <label>Menu</label>
                            <span class="field"><input type="text" name="TITLE" id="firstname2"
                                    class="input-block-level" value="<?php echo $objDetail['TITLE']?>"></span>
                        </p>

                        <p>
                            <label>Url</label>
                            <span class="field"><input type="text" name="URL" id="lastname2" class="input-block-level"
                                    value='<?php echo $objDetail['URL']?>'></span>
                        </p>
                        ...
                        <p>
                            <label>Posisi</label>
                            <span class="field">
                                <input type="radio" name="POS" value='TOP' style="opacity: 0;"
                                    <?php if($objDetail['POS']=='TOP') echo 'checked'?>> Top
                                <input type="radio" name="POS" value='FOOTER1'
                                    <?php if($objDetail['POS']=='FOOTER1') echo 'checked'?>> Footer1
                                <input type="radio" name="POS" value='FOOTER2'
                                    <?php if($objDetail['POS']=='FOOTER2') echo 'checked'?>> Footer2
