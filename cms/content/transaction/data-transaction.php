...
if($submitcontent=='1'){	
	...
	foreach($_REQUEST as $k=>$v){
		...
		if (in_array(strtoupper($k), $entity['transaction'])){
			$v=str_replace("'","`",$v);
...
$params['ORDER']='TRDATE DESC';
$list=getRecord('tbl_transaction',$params);
                    ...
                    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
						...
						?>
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="text-dark-75 font-weight-bolder d-block font-size-lg"><?php echo $list['TRID']?></span>
                                </td>
                                <td>
                                    <span
                                        class="text-dark-75 font-weight-bolder d-block font-size-lg"><?php echo $list['FULLNAME']?></span>
                                </td>
                                <td>
                                    <span
