...
$var['origin']='151';
$var['destination']=isset($_REQUEST['KAB'])?$_REQUEST['KAB']:'';
...
if($var['destination']>0){
	...
	//$shipping=$ao[0]['cost'][0]['value'];
	//foreach($ao as $list){
	//	//echo $list['service'].' - '.$list['description'].' - '.$list['cost'][0]['value'].' - '.$list['cost'][0]['etd'].'<br>';
	//}
	
	$sh=explode('-',$_REQUEST['COURIER']);
	$shipping=$sh[1];
}
?>
            ...
            <div class="row">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-3 pb-3">
                            <div class="shipment-img">
                                <img src="<?php echo ROOT_URL.'/images/product/'.$item['IMAGE']?>"
                                    class="img-fluid">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <ul class="list-group">
                                ...
                                <li
                                    ...
                                    Shipping
                                    <span class="badge badge-white">Rp. <?php echo number_format($shipping)?></span>
                                </li>
                            </ul>
                            <div class="line-grey"></div>
                            <ul class="list-group">
                                <li
                                    class="list-group-item d-flex justify-content-between align-items-center border-0 p-0 pt-2 pb-3">
                                    TOTAL
                                    <span class="badge badge-white"><?php echo number_format($total+$shipping)?></span>
                                </li>
                            </ul>
                ...
                <div class="col-md-6 offset-md-1">
				   ...
				   <form action='<?php echo ROOT_URL?>/thanks.php' method='POST' >
					...
					<input type='hidden' name='SHIPMENT' value='<?php echo $sh[0]?>'>
                    ...
                    <div class="shipment-method">
                        ...
                        <div class="form-check">
                            <!--input class="form-check-input" type="checkbox" name="SHIPMENT" value="REGULAR"-->
                            <label class="form-check-label label-payment">
                                <?php echo $sh[0]?><span>Rp. <?php echo number_format($shipping)?></span>
                            </label>
                        </div>
                    </div>
                    <div class="shipment-method mt-5">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="radio" name="PAYMENT" value="BCA" required selected>
                        ...
                        <!--div class="form-check mb-3">
                            <input class="form-check-input" type="radio" name="PAYMENT" value="BNI" required disabled>
                            <label class="form-check-label label-bank">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="radio" name="PAYMENT" value="BRI" required disabled>
                            <label class="form-check-label label-bank">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="radio" name="PAYMENT" value="MANDIRI" required disabled>
                            <label class="form-check-label label-bank">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="radio" name="PAYMENT" value="PERMATA" required disabled>
                            <label class="form-check-label label-bank">
