                        ...
                        <div class="col-md-12">
                            ...
                            <ul class="list-group">
                                ...
                                <li
                                    ...
                                    Shipping
                                    <span
                                        class="badge badge-white">Rp.&nbsp;<?php echo number_format($shipping); ?></span>
                                </li>
                            </ul>
                            <div class="line-grey"></div>
                            <ul class="list-group">
                                <li
                                    ...
                                    TOTAL
                                    <span
                                        class="badge badge-white">Rp.&nbsp;<?php echo number_format($total+9000)?></span>
                                </li>
                            </ul>
                    ...
                    <form action='<?php echo ROOT_URL?>/thanks.php' method='POST'>
                        ...
                        <div class="shipment-method mt-5">
                            ...
                            <div class="form-check">
                                <!--input class="form-check-input" type="checkbox" name="SHIPMENT" value="REGULAR"-->
                                <label class="form-check-label label-payment">
                                    Regular Shipment<span>Rp.&nbsp;<?php echo number_format("9000",2); ?></span>
                                </label>
                            </div>
                        </div>
                        <div class="shipment-method mt-5">
