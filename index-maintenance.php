...
<head>
    ...
    <title>Coming Soon | <?php echo $objConf['DD_SITENAME']?></title>
    <!-- Meta Tag -->
...
<body>
    ...
    <main>
    <?php if(!$isPhone){ ?>
        <img src="<?php echo ROOT_URL?>/assets/img/maintenance/coming_soon.jpg?<?php echo rand()?>" class="img-fluid"
            alt="">
    <?php }else{ ?>
        <img src="<?php echo ROOT_URL?>/assets/img/maintenance/coming_soon_mobile.jpg?<?php echo rand()?>" class="img-fluid"
            alt="">
    <?php } ?>
    </main>
    ...
    <!-- <script type="text/javascript">
        ...
        function redirect() {
            document.location.href = 'https://kamuakusehat.com';
        }
