            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="jumbotron jumbotron-after-shop">
                        <div class="container">
                            <h4>Thank You</h4>
                            <p><small class="text-muted">Your Payment Confirmation message has been successfully sent to
                                    our team.
                                    If all data are correct and valid, Your order will be shipped soon.
                                    Thank You very much.</small></p>
                        </div>
                    </div>
                </div>
            </div>
